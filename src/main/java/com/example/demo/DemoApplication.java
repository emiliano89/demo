...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		jdbcTemplate.execute("DROP TABLE shedlock IF EXISTS");
		jdbcTemplate.execute("CREATE TABLE SHEDLOCK( " +
		...
		jdbcTemplate.execute("CREATE TABLE CIUDAD(ID_CIUDAD INTEGER PRIMARY KEY NOT NULL , " +
				...
				"CURRENT VARCHAR(50) , TIMEZONE VARCHAR(50), FORECAST_DAYS INTEGER, TEMPERATURE VARCHAR(10))");
